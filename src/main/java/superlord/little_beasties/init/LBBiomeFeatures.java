...
public class LBBiomeFeatures {
	...
	public static final ResourceKey<BiomeModifier> ADD_MANEFISH_HIVE_TOWER = register("add_manefish_hive_tower");
	...
	public static void bootstrap(BootstapContext<BiomeModifier> bootstapContext) {
		...
		bootstapContext.register(ADD_MANEFISH_HIVE_TOWER, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(getBiome(bootstapContext, Biomes.WARM_OCEAN), getPlacedFeature(bootstapContext, LBPlacedFeatures.MANEFISH_HIVE_TOWER), GenerationStep.Decoration.VEGETAL_DECORATION));
