...
public class SandyHollowRemainStructure extends Structure {

	public static final Codec<SandyHollowRemainStructure> CODEC = simpleCodec(SandyHollowRemainStructure::new);

	public SandyHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		SandyHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.SANDY_HOLLOW_REMAINS.get();
	}
