...
public class SmallSpumeHollowRemainStructure extends Structure {

	public static final Codec<SmallSpumeHollowRemainStructure> CODEC = simpleCodec(SmallSpumeHollowRemainStructure::new);

	public SmallSpumeHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		SmallSpumeHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.SMALL_SPUME_HOLLOW_REMAINS.get();
	}
