...
public class BigBathyalHollowRemainStructure extends Structure {

	public static final Codec<BigBathyalHollowRemainStructure> CODEC = simpleCodec(BigBathyalHollowRemainStructure::new);

	public BigBathyalHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		BigBathyalHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.BIG_BATHYAL_HOLLOW_REMAINS.get();
	}
