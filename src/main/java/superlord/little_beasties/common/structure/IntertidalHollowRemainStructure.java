...
public class IntertidalHollowRemainStructure extends Structure {

	public static final Codec<IntertidalHollowRemainStructure> CODEC = simpleCodec(IntertidalHollowRemainStructure::new);

	public IntertidalHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		IntertidalHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.INTERTIDAL_HOLLOW_REMAINS.get();
	}
