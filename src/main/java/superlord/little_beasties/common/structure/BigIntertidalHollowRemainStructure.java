...
public class BigIntertidalHollowRemainStructure extends Structure {

	public static final Codec<BigIntertidalHollowRemainStructure> CODEC = simpleCodec(BigIntertidalHollowRemainStructure::new);

	public BigIntertidalHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		BigIntertidalHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.BIG_INTERTIDAL_HOLLOW_REMAINS.get();
	}
