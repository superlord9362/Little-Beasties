...
public class BigSpumeHollowRemainStructure extends Structure {

	public static final Codec<BigSpumeHollowRemainStructure> CODEC = simpleCodec(BigSpumeHollowRemainStructure::new);

	public BigSpumeHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		BigSpumeHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.BIG_SPUME_HOLLOW_REMAINS.get();
	}
