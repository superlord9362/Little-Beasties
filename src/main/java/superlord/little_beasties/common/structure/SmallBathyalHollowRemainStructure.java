...
public class SmallBathyalHollowRemainStructure extends Structure {

	public static final Codec<SmallBathyalHollowRemainStructure> CODEC = simpleCodec(SmallBathyalHollowRemainStructure::new);

	public SmallBathyalHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		SmallBathyalHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.SMALL_BATHYAL_HOLLOW_REMAINS.get();
	}
