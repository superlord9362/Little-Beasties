...
public class SmallMidnightHollowRemainStructure extends Structure {

	public static final Codec<SmallMidnightHollowRemainStructure> CODEC = simpleCodec(SmallMidnightHollowRemainStructure::new);

	public SmallMidnightHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		SmallMidnightHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.SMALL_MIDNIGHT_HOLLOW_REMAINS.get();
	}
