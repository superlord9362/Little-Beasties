...
public class BigSandyHollowRemainStructure extends Structure {

	public static final Codec<BigSandyHollowRemainStructure> CODEC = simpleCodec(BigSandyHollowRemainStructure::new);

	public BigSandyHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		BigSandyHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.BIG_SANDY_HOLLOW_REMAINS.get();
	}
