...
public class SmallSandyHollowRemainStructure extends Structure {

	public static final Codec<SmallSandyHollowRemainStructure> CODEC = simpleCodec(SmallSandyHollowRemainStructure::new);

	public SmallSandyHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		SmallSandyHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.SMALL_SANDY_HOLLOW_REMAINS.get();
	}
