...
public class SpumeHollowRemainStructure extends Structure {

	public static final Codec<SpumeHollowRemainStructure> CODEC = simpleCodec(SpumeHollowRemainStructure::new);

	public SpumeHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		SpumeHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.SPUME_HOLLOW_REMAINS.get();
	}
