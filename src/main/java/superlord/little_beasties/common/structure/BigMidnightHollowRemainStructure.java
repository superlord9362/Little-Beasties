...
public class BigMidnightHollowRemainStructure extends Structure {

	public static final Codec<BigMidnightHollowRemainStructure> CODEC = simpleCodec(BigMidnightHollowRemainStructure::new);

	public BigMidnightHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		BigMidnightHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.BIG_MIDNIGHT_HOLLOW_REMAINS.get();
	}
