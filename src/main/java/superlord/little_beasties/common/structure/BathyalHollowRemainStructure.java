...
public class BathyalHollowRemainStructure extends Structure {

	public static final Codec<BathyalHollowRemainStructure> CODEC = simpleCodec(BathyalHollowRemainStructure::new);

	public BathyalHollowRemainStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		BathyalHollowRemainPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.BATHYAL_HOLLOW_REMAINS.get();
	}
