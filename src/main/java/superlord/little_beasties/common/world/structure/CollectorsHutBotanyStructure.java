...
import superlord.little_beasties.common.world.structure.piece.CollectorsHutBotanyPieces;
import superlord.little_beasties.init.LBStructures.LBStructureType;

public class CollectorsHutBotanyStructure extends Structure {

	public static final Codec<CollectorsHutBotanyStructure> CODEC = simpleCodec(CollectorsHutBotanyStructure::new);

	public CollectorsHutBotanyStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		CollectorsHutBotanyPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return LBStructureType.COLLECTORS_HUT_BOTANY.get();
	}
